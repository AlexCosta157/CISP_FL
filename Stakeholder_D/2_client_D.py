...
IMAGE_SHAPE = (224, 224)
TRAINING_DATA_DIR = 'trainD224/'
# VALID_DATA_DIR = 'trainD224/'
...
prediction_layer = tf.keras.layers.Dense(2, activation='softmax')  #number = number of classes
...
class CifarClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        pd.DataFrame.from_dict(history.history).to_csv('clientDHistory_2.csv', index=False)
    ...
    def evaluate(self, parameters, config):
        ...
        ws['G2'] = "Precision"
        ws['G3'] = precision
        wb.save("FedD_basic_results_2.xlsx")
