...
class CifarClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        pd.DataFrame.from_dict(history.history).to_csv('3clientE_advancedFEDAVGHistory.csv', index=False)
    ...
    def evaluate(self, parameters, config):
        ...
        ws['G2'] = "Precision"
        ws['G3'] = precision
        wb.save("3FedE_advanced_results_FEDAVG.xlsx")
